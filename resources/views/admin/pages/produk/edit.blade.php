			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group form-label-group">
						...
						accept="{{ old('kode',$rc->kode_produk) }}"
						id="iKode" placeholder="iKode Produk" required>
					...
					<div class="form-group form-label-group">
						...
						accept="{{ old('nama_produk',$rc->nama_produk) }}"
